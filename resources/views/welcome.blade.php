                            ...
                            <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                                <div class="single-system">
                                    ...
                                    <div class="part-text">
                                        ...
                                        <p>Number of Completed Investments</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                                <div class="single-system">
                                    ...
                                    <div class="part-text">
                                        <h3 class="title">700+</h3>
                                        <p>NUmber of Succesfull Withdrawals</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-center">
                        <div class="col-xl-6 col-lg-6 col-sm-10">
                            <div class="part-text">
                                ...
                                <p>Get Profitable returns of the little or large amount of money that you have. <span class="spc">We have the best and instant</span> Merging system, that helps you get your ROI in a few matter of days</p>
                                <ul>
                                    <li><i class="fas fa-check"></i> Get Profitable returns of the little or large amount of money that you have. </li>
                                    <li><i class="fas fa-check"></i> Invest your funds in an extremely payable platform </li>
                                    <li><i class="fas fa-check"></i> We a highly trusted and super fast at deleivery </li>
                                </ul>
                                <a href="{{ route('dashboard') }}" class="btn-hyipox-2">Invest now</a>
                            </div>
                        </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                                        <div class="single-feature">
                                            ...
                                            <div class="feature-text">
                                                <h3>We Innovate</h3>
                                                <p>What could be better than a platform that offers you Ideas and effective strategies to make money</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                    ...
                    <div class="cta-bg">
                        <div class="row justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-center">
                            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-10 d-xl-flex d-lg-flex d-block align-items-center">
                                <div class="cta-text">
                                    <h2>Get Help & Provide Help</h2>
                                    <p>With the adverse circumstances of financial management across the globe, We are always thinking of expanding the horizon og online investment and harnessing peer-to-peer donation systems. </p>
                                    <p class="marked">This system is targetted at alleviating poverty levels across the globe, by helping users to connect and earn from each other</p>
                                    <a href="{{ route('dashboard') }}" class="btn-hyipox-medium cta-btn">Start Investing</a>
                                </div>
                            </div>
