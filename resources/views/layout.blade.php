...
<body>
        ...
        <!-- preloader begin-->
        <div class="preloader">
            <img src="{{URL::asset('assets/img/tenor.gif')}}" alt="">
        </div>
        <!-- preloader end -->
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-6 d-xl-block d-lg-block d-flex align-items-center justify-content-end">
                                        <div class="logo">
                                            <a href="{{ route('welcome') }}">
                                                <img src="{{URL::asset('assets/img/pycrest.png')}}" alt="" style="width: 100px; height:70px">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <nav class="navbar navbar-expand-lg">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            <ul class="navbar-nav ml-auto">
                                                <li class="nav-item">
                                                    <a class="nav-link " href="{{ route('welcome') }}" role="button" style="color: lightskyblue;" id="homeDropdown" aria-haspopup="true" aria-expanded="false">
                                                        Home
                                                    </a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ route('dashboard') }}" style="color: lightskyblue;">dashboard<span class="sr-only">(current)</span></a>
                                                </li>
